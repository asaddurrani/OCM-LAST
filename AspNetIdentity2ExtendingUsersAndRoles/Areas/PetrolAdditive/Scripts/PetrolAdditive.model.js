define(["ko", "underscore", "underscore-ko"], function (ko) {
    ...
    PetrolAdditive = function (specifiedPowerStereringOilId, specifiedPowerSterringOilName, specifiedPowerSterringOilCompany, specifiedPowerSterringOilPrice) {
    ...
    // Brake Oil Factory
    PetrolAdditive.Create = function (source) {
        return new PetrolAdditive(source.PowerStereringOilId, source.PowerSterringOilName, source.PowerSterringOilCompany, source.PowerSterringOilPrice);
    };
    //#endregion

    return {
        PetrolAdditive: PetrolAdditive,
    };
});